...
window.addEventListener('keydown', e => {
    ...
    if (k === 'escape') {
        if (typeof isBulletPreviewOpen === 'function' && isBulletPreviewOpen()) {
            if (typeof hideBulletPreview === 'function') hideBulletPreview();
            return;
        }
    ...
    if (typeof isBulletPreviewOpen === 'function' && isBulletPreviewOpen()) return;
    if (k === 'b') {
